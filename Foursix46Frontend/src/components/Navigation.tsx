...
//     path: "/services",
//   },
//   { id: "sectors", label: "Sectors", icon: Building2, path: "/sectors" }, // ✅ ADD THIS
...
//   // { id: "cookies", label: "Cookies Policy", icon: Cookie, path: "/cookies" },
//   // { id: "refund-policy", label: "Refund Policy", icon: PoundSterling, path: "/refund-policy" },
// ];
...
//     label: "TikTok",
//     icon: TiktokIcon,
//     path: "https://www.tiktok.com/@foursix46couriers?_r=1&_t=ZN-91aTcH3oW0M",
...
//     label: "Instagram",
//     icon: Instagram,
//     path: "https://www.instagram.com/foursix46hq/",
...
//     label: "Facebook",
//     icon: Facebook,
//     path: "https://www.facebook.com/share/1A15gqnztd/",
...
//     label: "YouTube",
//     icon: Youtube,
//     path: "https://youtube.com/@foursix46couriers?si=wUWQV7X-4bqouIe2",
...
//   // REFINED "Water Drop" Style: Cleaner, softer shadows, no harsh borders
...
//       active
//         ? "bg-red-50 text-[#E53935] font-bold shadow-[0_4px_20px_rgba(229,57,53,0.15)]" // Active: Soft Red Glow
//         : "hover:bg-white hover:shadow-[0_4px_20px_rgba(0,0,0,0.03)] text-gray-600 hover:text-black font-medium", // Inactive: Clean hover
//     );
...
//             direction: ltr;
//         }
//         /* Custom Scrollbar Styling - Very Subtle */
...
//       {/* DESKTOP NAVIGATION */}
//       <nav className="hidden lg:flex fixed right-0 top-0 h-screen w-72 bg-white/90 backdrop-blur-2xl z-50 flex-col overflow-y-auto nav-scroll-container shadow-[-20px_0_80px_rgba(0,0,0,0.05)] border-none">
//         <div className="p-6 w-full nav-content">
//           {/* Branding Header */}
//           <div
...
//             </div>
//             <span className="text-[#48AEDD] font-extrabold text-lg tracking-tight">
//               FourSix<span className="text-[#E53935]">46</span>
//             </span>
//           </div>
...
//       <nav
//         className={cn(
//           "lg:hidden fixed right-0 top-0 h-[100dvh] w-[280px] bg-white/95 shadow-2xl z-[70] flex-col overflow-y-auto transition-transform duration-300 ease-in-out will-change-transform transform-gpu",
...
//                       {item.label
//                         .replace(
//                           "Drive with FourSix46®",
//                           "Drive with FourSix46®",
//                         )
//                         .replace("Join Okapi's Network", "Join Okapi's Network")
//                         .replace("Quick Quote", "Quick Quote")}
//                     </span>
//                   </NavLink>
//                 </li>
//               );
