...
const step1Fields: (keyof BusinessData)[] = ["companyName", "registrationNumber", "businessType", "companyAddress"];
const step2Fields: (keyof BusinessData)[] = ["contactFirstName", "contactLastName", "contactEmail", "contactPhone", "jobTitle"];
const step3Fields: (keyof BusinessData)[] = ["monthlyShipments", "parcelTypes", "deliveryAreas"];
const step4Fields: (keyof BusinessData)[] = ["billingMethod", "termsAccepted", "billingEmail"];
...
export default function ForBusinessesPage() {
  ...
  return (
    <>
      ...
      {isSubmitting && <LoadingAnimation message="Submitting your business registration..." />}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/20 p-6 sm:p-10 mb-16 transition-all duration-500 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            <div className="text-center mb-8">
              ...
              <h1 className="text-4xl font-bold text-[#F81629] mb-2">For Businesses</h1>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              <div className="group border border-[#48AEDD]/20 rounded-2xl p-6 bg-gradient-to-br from-[#48AEDD]/5 to-transparent hover:shadow-lg hover:border-[#48AEDD]/40 transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-[#134467]">Business Benefits</h3>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-[#48AEDD] mt-1">✓</span>
                    <span className="text-muted-foreground"><strong>Volume Discounts:</strong> Get 20% off standard rates for bulk shipping</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#48AEDD] mt-1">✓</span>
                    <span className="text-muted-foreground"><strong>Dedicated Support:</strong> Account manager for your business</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#48AEDD] mt-1">✓</span>
                    <span className="text-muted-foreground"><strong>Flexible Billing:</strong> Monthly invoicing available</span>
                  </li>
                </ul>
              </div>
              <div className="group border border-[#E53935]/20 rounded-2xl p-6 bg-gradient-to-br from-[#E53935]/5 to-transparent hover:shadow-lg hover:border-[#E53935]/40 transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-[#134467]">Perfect For</h3>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="text-[#E53935]">•</span>
                    <span className="text-muted-foreground">E-commerce businesses</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#E53935]">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-[#E53935]">•</span>
                    <span className="text-muted-foreground">Wholesalers</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#E53935]">•</span>
                    <span className="text-muted-foreground">Any regular shipper</span>
                  </li>
                </ul>
              </div>
            </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="GB123456789" maxLength={11} {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="123 Business Park, City, Postcode" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} defaultValue={field.value}>
                            ...
                            <SelectContent>
                              <SelectItem value="1-50">1-50 shipments</SelectItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., Documents, Small packages, Equipment" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="e.g., London, Birmingham, Manchester" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                ...
                {currentStep === 4 && (
                  <div className="space-y-6">
                    ...
                    <div className="bg-muted/50 p-6 rounded-xl space-y-4">
                      <h3 className="font-semibold text-secondary">Business Rate Benefits</h3>
            ...
            <div className="flex justify-between mt-10">
              ...
              <Button variant="brand" onClick={handleNext} disabled={isSubmitting}>
                {currentStep === 4 ? (
                  isSubmitting ? (
                    <>
